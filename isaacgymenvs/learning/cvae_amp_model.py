...
from isaacgymenvs.learning.cvae_model import ModelcVAEContinuous


class ModelcVAEAMPContinuous(ModelcVAEContinuous):
    def __init__(self, network):
        super().__init__(network)
        return

    def build(self, config):
        net = self.network_builder.build("cvae_amp", **config)
    ...
    class Network(ModelcVAEContinuous.Network):
        ...
        def forward(self, input_dict):
            ...
            if is_train and "amp_obs" in input_dict:
