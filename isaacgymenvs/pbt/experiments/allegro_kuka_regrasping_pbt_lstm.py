from isaacgymenvs.pbt.experiments.allegro_kuka_pbt_base import kuka_base_cli, kuka_env
...
cli = (
    kuka_base_cli
    + f" task=AllegroKukaLSTM task/env=regrasping wandb_activate=True wandb_group={_wandb_group} pbt.num_policies={_pbt_num_policies}"
)
...
RUN_DESCRIPTION = RunDescription(
    ...
    experiment_dir_arg_name="hydra.run.dir",
    param_prefix="",
